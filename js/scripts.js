...
document.querySelectorAll('.navbar-nav a[href="#"], .navbar-brand').forEach(anchor => {
  anchor.addEventListener('click', function (e) {
      e.preventDefault();
      ...
      const headerPosition = header.getBoundingClientRect().top + window.scrollY - (viewportHeight / 2 - header.offsetHeight / 2);
